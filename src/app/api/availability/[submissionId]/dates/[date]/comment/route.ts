...
import { addAvailabilityDateReviewComment, findAvailabilitySubmissionEmployeeId, InvalidAvailabilityError } from "@/lib/availability";
import { toErrorResponse } from "@/lib/api-errors";

export async function POST(
  request: Request,
  ctx: RouteContext<"/api/availability/[submissionId]/dates/[date]/comment">
) {
  try {
    ...
    const updated = await addAvailabilityDateReviewComment(reviewer, submissionId, date, body.comment);
